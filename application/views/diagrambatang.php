    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [
          <?php 
          $jumlah_teknik = mysqli_query($koneksi,"select * from kegiatan");
          echo mysqli_num_rows($jumlah_teknik);
          ?>, 
          <?php 
          $jumlah_ekonomi = mysqli_query($koneksi,"select * from kegiatan");
          echo mysqli_num_rows($jumlah_ekonomi);
          ?>, 
          <?php 
          $jumlah_fisip = mysqli_query($koneksi,"select * from kegiatan");
          echo mysqli_num_rows($jumlah_fisip);
          ?>, 
          <?php 
          $jumlah_pertanian = mysqli_query($koneksi,"select * from kegiatan");
